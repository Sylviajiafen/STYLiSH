...
class STPaymentInfoTableViewCell: UITableViewCell {
    ...
    @IBOutlet weak var confirmToCheckOutBtn: UIButton!
    ...
    func layoutCellWith(
        ...
        productAmountLabel.text = NSLocalizedString("total", comment: "") + " (" + "\(productCount) " + NSLocalizedString("item", comment: "") + ")"
    }
